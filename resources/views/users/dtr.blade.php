...
<x-main-layout>
    <main class="w-full h-screen fixed top-0 bg-gray-100">

        <div class="h-full overflow-auto w-full pb-40 pt-[60rem] flex flex-col items-center justify-center">

            {{-- navbar bottom --}}
            <div
                class="w-full grid grid-cols-3 text-nowrap gap-5 bg-white p-3 border border-gray-200 shadow-lg absolute bottom-5 z-50 rounded-full max-w-screen-xl mx-auto">

                <section class="col-span-1 flex justify-start items-start">
                ...
                <section class="flex items-center gap-3 col-span-1 justify-center">
                    <form action="{{ route('users.dtr.post') }}" method="POST" class="inline">
                        @csrf
                        @method('POST')
                ...
                <section class="flex items-center gap-3 col-span-1 justify-end">
                    <x-button tertiary label="DTR Summary" routePath="users.dtr.summary" button
                    ...
                    <form
                        ...
                        @csrf
                        @method('POST')
                        <x-button primary label="Download PDF" leftIcon="material-symbols--download-rounded" submit
                            className="text-xs px-8" />
                    </form>
                </section>
            </div>
            ...
            <div class="w-1/2">
                ...
                <div
                    ...
                    <section class="space-y-2">
                        <p class="text-sm font-semibold">Name: <span
                                class="font-normal text-base capitalize">{{ $user->firstname }}
                                {{ $user->middlename }}
                                {{ $user->lastname }}</span></p>
                        <p class="text-sm font-semibold">Position: <span class="font-normal text-base">Intern</span></p>
                        <div class="flex items-center justify-between gap-3">
                            <p class="text-sm font-semibold">Hours This Month: <span
                                    class="font-normal text-base">{{ $totalHoursPerMonth }}
                                    Hours</span></p>
                    ...
                    <section class="h-auto w-full border border-gray-200 overflow-x-auto">
                        <table class="w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr class="text-center">
                                        <td colspan="4" class="border border-gray-300 px-4 py-2">No records found
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
