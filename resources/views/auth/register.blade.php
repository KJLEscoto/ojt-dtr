<x-main-layout>
    <div class="pb-20 h-full w-full">
        ...
        <x-form.container routeName="register" className="space-y-10 w-full pb-20">
            <section class="space-y-5 w-full">
                ...
                <div class="grid grid-cols-2 w-full gap-5">
                    <x-form.input label="Gender" name_id="gender" placeholder="Select a gender" small type="select"
